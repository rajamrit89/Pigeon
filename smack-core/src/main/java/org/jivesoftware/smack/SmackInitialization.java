...
import org.jivesoftware.smack.sasl.SASLPlain;
...
public final class SmackInitialization {
     ...
     *MINE 
     */
    private static final String DEFAULT_CONFIG_FILE = "classpath:"+System.getProperty("user.dir")+"/smack-core/src/main/resources/"+"org.jivesoftware.smack/smack-config.xml";
...
//        SASLAuthentication.registerSASLMechanism(new SASLPlain());
